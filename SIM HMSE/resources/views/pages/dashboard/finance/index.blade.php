                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <div class="flex justify-center items-center gap-1">
                                            ...
                                            {{-- Tombol Hapus --}}
                                            <form action="{{ route('dashboard.finance.destroy', $tx->id) }}" 
                                                    method="POST" 
                                                    class="inline-block"
                                                ...
                                                {{-- Atribut class dipindahkan ke sini agar tombol membungkus SVG tong sampah dengan pas --}}
                                                <button type="submit" 
                                                        class="flex p-2 text-red-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors focus:outline-none" 
