...
<head>
    ...
    <title>Proposal (Final) Resiko Rendah - {{ $proposal->title }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .header {
            text-align: center;
            border-bottom: 3px solid #2C3DA6;
            padding-bottom: 20px;
            margin-bottom: 30px;
        }
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <span class="risk-badge">Resiko Rendah</span>
            @if($proposal->isFullyApproved())
            <span class="approved-badge">✓ DISETUJUI</span>
            @endif
        </div>

        <!-- Title -->
        <div class="section">
            <h2 style="font-size: 18px; color: #2C3DA6; margin-bottom: 10px;">{{ $proposal->title }}</h2>
        </div>
        ...
        <!-- Risiko & Mitigasi -->
        <div class="section">
            <div class="section-title">RISIKO & MITIGASI</div>
            <div class="section-content">
